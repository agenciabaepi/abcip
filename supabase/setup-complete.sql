-- Script completo de setup do banco de dados ABCIP
...
DROP POLICY IF EXISTS "Associates are viewable by everyone" ON associates;
DROP POLICY IF EXISTS "About page is viewable by everyone" ON about_page;
DROP POLICY IF EXISTS "Footer settings are viewable by everyone" ON footer_settings;
...
DROP POLICY IF EXISTS "Admins can insert associates" ON associates;
DROP POLICY IF EXISTS "Admins can update associates" ON associates;
DROP POLICY IF EXISTS "Admins can delete associates" ON associates;
DROP POLICY IF EXISTS "Admins can manage about page" ON about_page;
DROP POLICY IF EXISTS "Admins can insert about page" ON about_page;
DROP POLICY IF EXISTS "Admins can update about page" ON about_page;
DROP POLICY IF EXISTS "Admins can delete about page" ON about_page;
...
DROP POLICY IF EXISTS "Admins can delete footer settings" ON footer_settings;
