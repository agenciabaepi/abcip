  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:pr-6 lg:pr-8">
        <div className="flex items-center justify-between h-24 sm:h-26 md:h-28 lg:h-32 w-full">
          {/* Logo - Esquerda */}
          ...
          <nav className="hidden lg:flex items-center justify-center flex-1 space-x-4 xl:space-x-6 mx-8">
            {navLinks.map((link) => {
              ...
              if (link.hasDropdown && link.dropdownItems) {
                return (
                  ...
                  >
                    <Link
                      href={link.href}
                      className={`font-archivo text-lg xl:text-2xl font-medium transition-colors relative pb-1 whitespace-nowrap flex items-center gap-1 ${
                        active
                          ? "text-primary-400"
                          : "text-dark-900"
                      }`}
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`font-archivo text-lg xl:text-2xl font-medium transition-colors relative pb-1 whitespace-nowrap ${
                    active
                      ? "text-primary-400"
                      : "text-dark-900"
                  }`}
              ...
              {navLinks.map((link) => {
                  ...
                  return (
                    <div key={link.href}>
                      <button
                        ...
                        className={`font-archivo w-full px-4 py-3 text-xl font-medium rounded-lg transition-colors flex items-center justify-between ${
                          active
                ...
                return (
                  <Link
                    ...
                    className={`font-archivo px-4 py-3 text-xl font-medium rounded-lg transition-colors flex items-center gap-2 ${
                      active
                        ? "text-primary-400 bg-primary-50"
                        : "text-dark-900 hover:bg-gray-50"
                    }`}
