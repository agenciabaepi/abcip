  ...
  return (
    <footer className="w-full">
      ...
      >
        ...
        {/* Container principal */}
        <div className="relative z-10 w-full h-full px-16 py-8 flex items-start justify-between">
          {/* Lado Esquerdo - Logo e Textos */}
          <div className="flex items-start gap-8">
            {/* Logo ABCIP - MUITO MAIOR */}
            ...
            <div className="text-white mt-4">
              <div className="text-base leading-tight mb-6 max-w-sm">
          ...
          <div className="flex flex-col items-end mt-4">
            {/* Ícones das redes sociais - MAIORES */}
