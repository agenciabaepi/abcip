  ...
  return (
    <footer className="w-full">
      ...
      >
        ...
        <div className="relative z-10 w-full min-h-[350px] lg:h-[350px] flex flex-col lg:flex-row items-center lg:items-center lg:justify-between px-6 py-12 sm:px-8 sm:py-14 md:px-10 md:py-16 lg:pl-20 lg:pr-12 lg:py-0">
          {/* Lado Esquerdo - Logo e Textos */}
          <div className="flex flex-col items-center lg:items-start justify-center text-center lg:text-left mb-12 lg:mb-0">
            {/* Logo */}
            <div className="mb-4 sm:mb-5 lg:mb-6">
              {siteSettings?.logo_white_url ? (
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full bg-white/10 flex items-center justify-center">
                    <div className="w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-green-400 flex items-center justify-center">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-white rounded-full"></div>
                    </div>
                  </div>
                  <div className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-wide">
            ...
            {/* Descrição */}
            <div className="text-white text-sm sm:text-base md:text-lg lg:text-xl leading-tight mb-4 sm:mb-5 lg:mb-6 font-extralight max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl">
              Associação Brasileira das Concessionárias<br />
              de Iluminação Pública e Cidades Inteligentes
            </div>

            {/* Endereço */}
            <div className="text-white text-sm sm:text-base md:text-lg lg:text-xl leading-tight font-extralight">
          ...
          <div className="flex flex-col items-center lg:items-end justify-center lg:justify-end lg:pb-12">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5 lg:mb-6">
              {footerSettings?.linkedin && (
                <a
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full bg-white text-black flex items-center justify-center hover:bg-gray-100 transition-colors"
                  aria-label="LinkedIn"
                >
