...
export default function AdminContatoPage() {
  const [settings, setSettings] = useState<ContatoPageSettings | null>(null);
  ...
  async function uploadBannerImage(file: File) {
    ...
    try {
      ...
      const fileName = `banner-contato-${Date.now()}.${fileExt}`;
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Configurações da Página de Contato</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">
            O banner será exibido no topo da página de contato.
          </p>
        </div>
      </div>
    </div>
